...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt_dir', type=str, default='./ckpt/3/')
    ...
    tag_idx_path = os.path.join(opt.cache_dir, "tag2idx.json")
    f = open(tag_idx_path)
    tag2idx = json.load(f)
    ...
    # train & eval datasets
    datasets = {split: slot_tag(split_data, vocab, tag2idx, num_class) for split, split_data in data.items()}
